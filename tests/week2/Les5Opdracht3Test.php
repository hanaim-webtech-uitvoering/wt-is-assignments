...
require('src/week2/Les5Opdracht3_FilmNaarHTML.php');

final class Les5Opdracht3Test extends TestCase
{
    ...
    function testFilmPlaatje () {
        ...
        $result = enkeleFilmNaarHTML($films[0]);
        
        $this->assertIsString($result);
        $this->assertStringContainsStringIgnoringCase( $films[0]['title'], $result);

        // mogelijk nog een test die html valideert?
